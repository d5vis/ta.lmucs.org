    ...
    <Card className="w-full h-full text-left gap-4 rounded-2xl p-8">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <div>
          <ul className="list-disc list-inside">
            <li>
              No! CS TAs are general TAs, so you can ask any one of them for
              help.
            </li>
          </ul>
        </div>
        ...
        <div>
          <ul className="list-disc list-inside">
            <li>
              Ask your professor if you have an assignment-specific question
              (i.e. “When is this assignment due?” or “How should I submit my
              answer?”).
            </li>
            <li>
              Ask a TA when you have a coding-specific or more general question
              (i.e. “I can’t figure out why I’m getting this output…”, “How
              would you approach solving this problem?”, or “I can’t wrap my
              head around this concept we learned.”)
            </li>
            <li>
              If you’re not sure, go ahead and ask a TA! They can redirect you
              to a professor if necessary
            </li>
          </ul>
        </div>
        <Separator className="mt-4 mb-4" />
